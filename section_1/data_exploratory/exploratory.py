...
dataset_1 = pd.read_csv("../source/2022-09-24/dataset1.csv")
profile_1 = ProfileReport(dataset_1, title="dataset1")
profile_1.to_file("dataset1_profiling_result")

dataset_2 = pd.read_csv("../source/2022-09-24/dataset2.csv")
...
# dataset_2 is of poorer data quality with empty fields in name and text field in price
